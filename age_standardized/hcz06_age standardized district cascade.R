...
write_csv(.,path = "age_standardized/hcz06_age standardized district cascade.csv")


# df <- read_csv(file="age_standardized/hcz02_age standardized state cascade.csv") %>%
...
#             by=c("state"="v024"))
# write_csv(df,file = "age_standardized/hcz02_age standardized state cascade.csv")
