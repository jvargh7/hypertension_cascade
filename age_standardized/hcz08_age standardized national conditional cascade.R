...
n5_sy %>% 
  write_csv(.,file = "age_standardized/hcz08_total age standardized national conditional cascade.csv")
...
bind_rows(unmet_svysummary_htntreat_national,
  ...
  write_csv(.,file = "age_standardized/hcz08_national conditional cascade.csv")
