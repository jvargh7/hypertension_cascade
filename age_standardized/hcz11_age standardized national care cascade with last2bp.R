...
write_csv(national_summary,"age_standardized/hcz11_total age standardized national care cascade with last2bp.csv")
...
bind_rows(nfhs5_svysummary,
  ...
  write_csv(.,path = "age_standardized/hcz11_age standardized national care cascade with last2bp.csv")
