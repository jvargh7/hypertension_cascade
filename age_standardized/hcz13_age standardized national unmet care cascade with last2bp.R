...
bind_rows(
  ...
  write_csv(.,file = "age_standardized/hcz13_national unmet need care cascade with last2bp.csv")
...
bind_rows(unmet_svysummary_htn,
          ...
          unmet_svysummary_htntreat_national) %>% 
  dplyr::filter(!str_detect(variable,"htn_un")) %>% 
  write_csv(.,file = "age_standardized/hcz13_national met need care cascade with last2bp.csv")
