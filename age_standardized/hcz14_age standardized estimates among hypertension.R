...
proportion_vars <- c("htn_diagnosed","htn_treated","htn_controlled")
...
write_csv(national_summary,"age_standardized/hcz14_total age standardized estimates among hypertension.csv")

# NATIONAL ----------
nfhs5_svysummary_national <- map_dfr(group_vars[-1],
                                     function(g_v){
                                       id_vars = c(g_v);
                                       n5_sy <- svysummary(nfhs5htnz_svydesign,
                                                           # c_vars = continuous_vars,
                                                           p_vars = proportion_vars,
                                                           # g_vars = grouped_vars,
                                                           id_vars = id_vars
...
bind_rows(nfhs5_svysummary,
  ...
  write_csv(.,path = "age_standardized/hcz14_age standardized estimates among hypertension.csv")
