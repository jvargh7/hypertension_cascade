...
# REGIONAL ------
  nfhs5_svysummary_regional <- map_dfr(group_vars,
                                     function(g_v){
...
bind_rows(nfhs5_svysummary_national,
          nfhs5_svysummary_regional) %>% 
write_csv(.,file = "analysis/hca02_national level care cascade.csv")
