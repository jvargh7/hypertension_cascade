...
write_csv(national_summary,"cutoff 130 and 80/hcc130z01_total age standardized national care cascade.csv")
...
bind_rows(nfhs5_svysummary,
  ...
  write_csv(.,path = "cutoff 130 and 80/hcc130z01_age standardized national care cascade.csv")
