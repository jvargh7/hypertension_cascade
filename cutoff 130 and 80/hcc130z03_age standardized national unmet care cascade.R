...
bind_rows(
  ...
  write_csv(.,file = "cutoff 130 and 80/hcc130z03_national unmet need care cascade.csv")
...
bind_rows(  unmet_svysummary_htn,
            ...
            unmet_svysummary_htntreat_national) %>% 
  dplyr::filter(!str_detect(variable,"htn_un")) %>% 
  write_csv(.,file = "cutoff 130 and 80/hcc130z03_national met need care cascade.csv")
