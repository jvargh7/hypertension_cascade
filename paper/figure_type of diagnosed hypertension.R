...
write_csv(figure_diagnosed_df,"paper/figure_type of diagnosed hypertension.csv")
...
figure_diagnosed %>% 
  ggsave(.,filename=paste0(path_cascade_folder,"/figures/figure_type of diagnosed hypertension.png"),width=8,height=6)
