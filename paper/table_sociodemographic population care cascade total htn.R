...
nested <- read_csv(file = "age_standardized/hcz14_age standardized estimates among hypertension.csv") %>% 
...
bind_rows(population,
  ...
  write_csv(.,"paper/table_sociodemographic population care cascade total htn.csv")
