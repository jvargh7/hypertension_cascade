...
nfhs5pop_htn_design <- nfhs5pop_df %>% 
...
nfhs5_national <- map_dfr(group_vars,
                         function(g_v){
                           id_vars = c(g_v);
                           n5_sy <- svysummary(nfhs5pop_design,
...
nfhs5_regional <- map_dfr(group_vars,
                         function(g_v){
...
nfhs5_htn_national <- map_dfr(group_vars,
                             function(g_v){
                               id_vars = c(g_v);
                               n5_sy <- svysummary(nfhs5pop_htn_design,
                                                   # c_vars = continuous_vars,
...
nfhs5_htn_regional <- map_dfr(group_vars,
                             function(g_v){
                               id_vars = c("residence",g_v);
                               n5_sy <- svysummary(nfhs5pop_htn_design,
                                                   # c_vars = continuous_vars,
...
write_csv(nfhs5_national,"qc/nfhs5 national equivalent estimates.csv")
write_csv(nfhs5_regional,"qc/nfhs5 regional equivalent estimates.csv")
write_csv(nfhs5_htn_national,"qc/nfhs5 national equivalent nested estimates.csv")
write_csv(nfhs5_htn_regional,"qc/nfhs5 regional equivalent nested estimates.csv")
