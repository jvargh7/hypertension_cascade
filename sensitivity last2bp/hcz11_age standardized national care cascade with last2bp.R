...
source("preprocessing/hcpre13_nfhs5 total svydesign with last2bp.R")
...
write_csv(national_summary,"sensitivity last2bp/hcz11_total age standardized national care cascade with last2bp.csv")
...
bind_rows(nfhs5_svysummary,
  ...
  write_csv(.,path = "sensitivity last2bp/hcz11_age standardized national care cascade with last2bp.csv")
