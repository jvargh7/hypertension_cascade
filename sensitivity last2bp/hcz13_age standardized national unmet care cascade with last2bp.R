...
unmet_svysummary_htntreat_national <- future_map_dfr(group_vars[-1],
                                                    function(g_v){
                                                      id_vars = c(g_v);
                                                      print(g_v);
...
bind_rows(
  ...
  write_csv(.,file = "sensitivity last2bp/hcz13_national unmet need care cascade with last2bp.csv")
...
bind_rows(unmet_svysummary_htn,
          ...
          unmet_svysummary_htntreat_national) %>% 
  dplyr::filter(!str_detect(variable,"htn_un")) %>% 
  write_csv(.,file = "sensitivity last2bp/hcz13_national met need care cascade with last2bp.csv")
